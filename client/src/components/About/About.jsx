    ...
    <div className="container">
      <div className="about-content">
         ...
         <div className="about-content-right">
            <img src={`${process.env.REACT_APP_SERVER_URL}/img/img_about/about1.jpg`} width="600px" height="600px" alt="about-img" />
          </div>
      </div>
      <div className="about-content">
        <div className="about-content-left">
            <img src={`${process.env.REACT_APP_SERVER_URL}/img/img_about/2.jpg`} width="600px" height="600px" alt="about-img" />
</div>
<div className="about-content-right">
...
<div className="about-content-right">
            <img src={`${process.env.REACT_APP_SERVER_URL}/img/img_about/3.jpg`} width="600px" height="600px" alt="about-img" />
</div>
      </div>
   </div>
  );
