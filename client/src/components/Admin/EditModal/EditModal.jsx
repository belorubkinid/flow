...
function ModalOrder({handleClose, bouquet}) {
  ...
  async function handleSubmit(event) {
    ...
    axios.post(`${process.env.REACT_APP_SERVER_URL}/bouquets/edit/${bouquet.id}`, formData, {
      headers: {
    ...
    <div className='modal-order'>
        ...
        <form onSubmit={handleSubmit}>
            ...
            <div className="card-input">
              ...
              <textarea value={description} onChange={(e) => setDescription(e.target.value)} type="text" name="description" className="card-input__input"></textarea>
            </div>
            <div className="card-input">
